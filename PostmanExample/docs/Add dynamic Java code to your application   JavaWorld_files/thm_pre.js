	...
	var $thm = {
		...
		setDeviceClassAdSizes:function(width) {
			...
			if (width >= this.deviceBreakpoints.wide) {
				...
				IDG.GPT.addSlot("sponsored-pst", [200,126]);
				IDG.GPT.addOtherAd("overlayimu", [[640,480],[300,250]]);
				//IDG.GPT.addSlot("bottomleaderboard", [[950,98],[728,90]]);
				//IDG.GPT.addSlot("overlayimu", [[320,50],[300,1050],[300,600],[300,250],[300,50]]);
				//IDG.GPT.addSlot("featuredsponsors", [336,280]);
				//IDG.GPT.addSlot("ciu", [[950,335],[943,335],[947,335],[919,345],[970,335],[934,335],[922,395]]);
				//IDG.GPT.addSlot("hoverad", [336,90]);
				//IDG.GPT.addSlot("leadgenpromo", [334,126]);
				//IDG.GPT.addSlot("newsletter_intercept", [770,1]);
				//IDG.GPT.addSlot("linkedIn_toolbadge", [128,45]);
				//IDG.GPT.addSlot("slideshowpromo", [340,70]);
				//IDG.GPT.addSlot("sidekick", [60,968]);
				//IDG.GPT.addSlot("articlepromoright", [[336,250],[336,125]]);
				//IDG.GPT.addSlot("sidecar", [[60,55],[130,55]]);
				//IDG.GPT.addSlot("intercept", [420,30]);
			}
			else if (width > this.deviceBreakpoints.mobile) {
		...
		setIDGTargetings: function() {
			try {
				...
				//this.premiumAdOptStatus = this.setPremiumAdOptStatus() && global_PremiumAdOptStatus;
				//IDG.GPT.addTarget("insiderauth", this.premiumAdOptStatus);
